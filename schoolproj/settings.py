...
SECRET_KEY = 'django-insecure-q#6735ldv^@+jhwohei^nnc3i#*t8xgo&zv#*(ps7=jv=!rpof'
...
LOGGING = {
    ...
    'loggers': {
        'django.server': { #override to control HTTP logging
    ...
    'formatters': {
        'generic': {
            ...
            'format': '{name} {levelname}@[{server_time}]: \n\t{message}\n',
            'style': '{',
        }
    }
}